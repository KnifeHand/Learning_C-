If you take a look at the source code, the class defineds an object called Volume. 
 ...
 files we can give the object of the same names and inherit them later if we need them.
